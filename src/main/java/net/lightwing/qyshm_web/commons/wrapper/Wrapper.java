...
package net.lightwing.qyshm_web.commons.wrapper;
...
public class Wrapper<T> implements Serializable {
	 ...
	 * 错误码.
	 */
	public static final Object ERROR_CODE = 500;
	 ...
	 * 错误码：参数非法
	 */
	public static final Object ILLEGAL_ARGUMENT_CODE_ = 100;
	 ...
	 */
	Wrapper(Object code, String message) {
	 ...
	 */
	Wrapper(Object code, String message, T result) {
		super();
	 ...
	 * @return the wrapper
	 */
	public Wrapper<T> code(Object code) {
		this.setCode(code);
		return this;
	}
